...
def display_trends(data: Dict, role: str, period: str):
    ...
    for trend in data["trands"]:
        ...
        st.markdown(
            f"<a style='color: white; text-decoration: none; font-size: 18px; font-weight: 500; padding: 0px; margin: 0px' href='?trend={trand_title}&role={role}&period={period}'>{trand_title}</a>",
